...
object AppOpCatalog {
    ...
    private val catalog: List<AppOp> = listOf(
        ...
        AppOp("GET_ACCOUNTS", "获取账户", OpGroup.PRIVACY),
        AppOp("MOCK_LOCATION", "模拟定位", OpGroup.PRIVACY),
        ...
        AppOp("MONITOR_LOCATION", "持续定位", OpGroup.LOCATION),
        AppOp("MONITOR_HIGH_POWER_LOCATION", "高功耗持续定位", OpGroup.LOCATION),
        ...
        AppOp("WRITE_MEDIA_VIDEO", "写入视频", OpGroup.MEDIA),
        AppOp("READ_MEDIA_AUDIO", "读取音频", OpGroup.MEDIA),
        AppOp("WRITE_MEDIA_AUDIO", "写入音频", OpGroup.MEDIA),
